 ...
 * CLOSED, INIT, TRYOPEN, OPEN, FROZEN or UNINITIALIZED.
 */
export enum State {
  ...
  STATE_CLOSED = 4,
  /**
   * STATE_FROZEN - A channel has been forced closed due to a frozen client in the connection
   * path.
   */
  STATE_FROZEN = 5,
  /**
   * STATE_TRY_PENDING - A channel has acknowledged the handshake step on the counterparty chain, but not yet confirmed with a virtual
   * chain. Virtual channel end ONLY.
   */
  STATE_TRY_PENDING = 6,
  /**
   * STATE_ACK_PENDING - A channel has finished the ChanOpenAck handshake step on chain A, but not yet confirmed with the corresponding
   * virtual chain. Virtual channel end ONLY.
   */
  STATE_ACK_PENDING = 7,
  /**
   * STATE_CONFIRM_PENDING - A channel has finished the ChanOpenConfirm handshake step on chain B, but not yet confirmed with the corresponding
   * virtual chain. Virtual channel end ONLY.
   */
  STATE_CONFIRM_PENDING = 8,
  /**
   * STATE_CLOSE_CONFIRM_PENDING - A channel has finished the ChanCloseConfirm step on chainB, but not yet confirmed with the corresponding
   * virtual chain. Virtual channel end ONLY.
   */
  STATE_CLOSE_CONFIRM_PENDING = 9,
  UNRECOGNIZED = -1,
}
...
export function stateFromJSON(object: any): State {
  switch (object) {
    ...
    case 6:
    case "STATE_TRY_PENDING":
      return State.STATE_TRY_PENDING;
    case 7:
    case "STATE_ACK_PENDING":
      return State.STATE_ACK_PENDING;
    case 8:
    case "STATE_CONFIRM_PENDING":
      return State.STATE_CONFIRM_PENDING;
    case 9:
    case "STATE_CLOSE_CONFIRM_PENDING":
      return State.STATE_CLOSE_CONFIRM_PENDING;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function stateToJSON(object: State): string {
  switch (object) {
    ...
    case State.STATE_FROZEN:
      return "STATE_FROZEN";
    case State.STATE_TRY_PENDING:
      return "STATE_TRY_PENDING";
    case State.STATE_ACK_PENDING:
      return "STATE_ACK_PENDING";
    case State.STATE_CONFIRM_PENDING:
      return "STATE_CONFIRM_PENDING";
    case State.STATE_CLOSE_CONFIRM_PENDING:
      return "STATE_CLOSE_CONFIRM_PENDING";
