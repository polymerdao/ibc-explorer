...
export interface ClientState {
  ...
  chainMemo: string;
  /**
   * Optimism is an L2 and is dependent on the eth L1 client.
   * Dependent client IDs are always specified as virtual client IDs.
   */
  dependentClientIds: string[];
  /** The L2 output oracle contract addr is fixed on a per client basis. */
  l2OutputOracleAddr: Uint8Array;
...
/** ConsensusState defines the consensus state from Optimism. */
...
function createBaseClientState(): ClientState {
  return {
    ...
    chainMemo: "",
    dependentClientIds: [],
    l2OutputOracleAddr: new Uint8Array(),
...
export const ClientState = {
  encode(message: ClientState, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.l2OutputOracleAddr.length !== 0) {
      writer.uint32(42).bytes(message.l2OutputOracleAddr);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          break;
        case 5:
          message.l2OutputOracleAddr = reader.bytes();
          break;
        case 6:
  ...
  fromJSON(object: any): ClientState {
    return {
      ...
      dependentClientIds: Array.isArray(object?.dependentClientIds)
        ...
        : [],
      l2OutputOracleAddr: isSet(object.l2OutputOracleAddr)
        ? bytesFromBase64(object.l2OutputOracleAddr)
        : new Uint8Array(),
  ...
  toJSON(message: ClientState): unknown {
    ...
    message.l2OutputOracleAddr !== undefined &&
      (obj.l2OutputOracleAddr = base64FromBytes(
        message.l2OutputOracleAddr !== undefined ? message.l2OutputOracleAddr : new Uint8Array(),
      ));
  ...
  fromPartial<I extends Exact<DeepPartial<ClientState>, I>>(object: I): ClientState {
    ...
    message.l2OutputOracleAddr = object.l2OutputOracleAddr ?? new Uint8Array();
...
export const ConsensusState = {
  encode(message: ConsensusState, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.outputRoot.length !== 0) {
      writer.uint32(18).bytes(message.outputRoot);
    }
    if (message.rawHeader.length !== 0) {
      writer.uint32(26).bytes(message.rawHeader);
    }
