...
/**  returns a default signer opts object with all module registry types */
export function signerOpts() {
  return {
    prefix: chainPrefix,
    gasPrice: GasPrice.fromString('0stake'),
    registry: new Registry(defaultRegistryTypes.concat(polyibc.txMsgTypes))
  }
}
