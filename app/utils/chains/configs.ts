...
let moltenDispatcherSimClient =
  process.env.DISPATCHER_ADDRESS_MOLTEN_SIMCLIENT!;
...
let optimismRPC =
  ...
  'https://opt-sepolia.g.alchemy.com/v2/jKvLhhXvtnWdNeZrKst0demxnwJcYH1o';
let baseRPC =
  process.env.BASE_RPC ||
  'https://base-sepolia.g.alchemy.com/v2/776dC6qT-NTtupdnxlUJuXGbUIKWWhLe';
let moltenRPC =
  process.env.MOLTEN_RPC || 'https://unidex-sepolia.rpc.caldera.xyz/http';
